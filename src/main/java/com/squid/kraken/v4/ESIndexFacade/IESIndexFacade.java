...
public interface IESIndexFacade {
	 ...
	 * 
	 * public void removeProject(String projectName) throws
	 * ESIndexFacadeException;
	 */
	...
	public void updateDimension(String domainName, String dimensionName, HashMap<String, ESMapping> mapping)
	...
	public String addDimensionMember(String domainName, String dimensionName, String id,
			HashMap<String, Object> attributes, HashMap<String, ESMapping> mappings) throws ESIndexFacadeException;

	public void updateDimensionMember(String domainName, String dimensionName, String id,
			HashMap<String, Object> attributes, HashMap<String, ESMapping> mappings) throws ESIndexFacadeException;
	 ...
	 * searchNFirstDimensionMembersByAttributes( String projectName, String
	 * dimensionName, HashMap<String, Object> attributes, int nbResults) throws
	 * ESIndexFacadeException;
	 */
	...
	MappingState computeCorrelationMappingState(String domainName, String hierarchyName,
