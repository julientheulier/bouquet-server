...
import com.squid.kraken.v4.caching.awsredis.RedisCacheProxyMock;
import com.squid.kraken.v4.caching.awsredis.ServerID;

public class GenerationalKeysServerMock extends GenerationalKeysServerStandard {
    ...
    protected IRedisCacheProxy initRedisService(ServerID redisID) {
    	...
    	return new RedisCacheProxyMock();
    }

    public GenerationalKeysServerMock() {
        super(null);
    }
