...
public class GenerationalKeysServerFactory {
	...
	public static final GenerationalKeysServerFactory INSTANCE = new GenerationalKeysServerFactory();
	
	public static  IGenerationalKeysServer instServ=null;
	
    static final Logger logger = LoggerFactory.getLogger(GenerationalKeysServerFactory.class);
    
    public IGenerationalKeysServer getGenerationalKeysServer(){
    ...
    public IGenerationalKeysServer getNewGenerationalKeysServer(AWSRedisCacheConfig conf, boolean onLocalhost){
    	if (instServ== null){
    		if (onLocalhost ||  conf.getGenerationalKeysServerID().port ==-1){
    			...
    			instServ= new GenerationalKeysServerStub(conf.getGenerationalKeysServerID(), conf.getAppName());
    		}
    	}
    	return instServ;
    }
