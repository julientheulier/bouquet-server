...
public class ExecutionItemExportSource implements IRawExportSource {
  ...
  public ExecutionItemExportSource(ExecuteAnalysisResult result) throws SQLException {
    ...
    int[] rawTypes = vendorSpecific.getVendorMetadataSupport().normalizeColumnType(rs);
    for (int i = 0; i < columnCount; i++) {
