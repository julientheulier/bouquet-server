...
public class ContinuousAxisMapping extends AxisMapping {

	private SimpleMapping kmin;
	private SimpleMapping kmax;

	public ContinuousAxisMapping(Axis axis, SimpleMapping kmin, SimpleMapping kmax) {
		super(null, axis);
		this.kmin = kmin;
		this.kmax = kmax;
	}
