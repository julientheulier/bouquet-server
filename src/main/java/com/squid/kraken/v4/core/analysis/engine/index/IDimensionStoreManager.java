...
public interface IDimensionStoreManager {
     ...
     * It makes sure that the underlying storage engine will clean-up stale data.
     * @param project
     * @throws InterruptedException 
     */
//    public void invalidate(Project project) throws InterruptedException;

    public void stop();

	void invalidate(DomainPK domain) throws InterruptedException;
