...
public class DimensionStoreManagerMock implements IDimensionStoreManager {

	static final Logger logger = LoggerFactory
			.getLogger(DimensionStoreManagerMock.class);
	
	
    @Override
    public IDimensionStore createIndexStore(DimensionIndex index)
            throws InterruptedException {
        logger.info("createIndexStore : "+index);
        return new DimensionStoreMock();
    }
