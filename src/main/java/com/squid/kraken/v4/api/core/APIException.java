...
public class APIException extends RuntimeException {
	...
	static public enum ApiError {
		DUPLICATE_LOGIN, DUPLICATE_EMAIL, PASSWORD_REQUIRED, PASSWORD_INVALID_SIZE, PASSWORD_INVALID_CHAR, PASSWORD_INVALID_RULES, COMPUTING_IN_PROGRESS, COMPUTING_FAILED
	};
